...
import  Bsalers  from './pages/Bsalers';
...
function App() {
  ...
  window.onmousewheel = e => {
    headerRef.current.style.top = e.deltaY === 125 ? '-500px' : 0
  }
  ...
  return (
    <Context.Provider value={properties}>
      <div className="App">
        ...
        <Cart />
        <Payments />
        <a href="#headermain" className='up'><BsArrowUpSquareFill /></a>
        ...
        <Routes>
                ...
                <Route path='/bestsalers' element={<Bsalers />}></Route>
        </Routes>
      </div>
    </Context.Provider>
  );
